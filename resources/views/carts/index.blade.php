	...
	<div class="container">
		@if ($cart->isEmpty())
			<div class="text-center">
				...
				<p><a href="{{ url('/catalogs') }}">Lihat semua product <i class="fa fa-arrow-right"></i></a></p>
			</div>
		@else
					...
					@foreach ($cart->details() as $order)
						<tr>
							...
							<td class="actions" data-th="">
									{!! Form::button('<i class="fa fa-refresh"></i>', ['type'=>'submit','class'=>'btn btn-info btn-sm']) !!}
								{!! Form::close() !!}

								{!! Form::open(['url'=>['cart',$order['id']],'method'=>'delete','class'=>'form-inline']) !!}
									{!! Form::button('<i class="fa fa-trash-o"></i>', [
										'type' => 'submit',
										'class'=>'btn btn-danger btn-sm js-submit-confirm',
